...
#make dataset of population by age
...
```
###Growth rates
The folllowing charts show the projected compound growth rates of each age category. 
...
```{r circularCAGR2025}
#make a version of the dataset with only the totals for each district
...
#make dataset for plotting raw pop numbers
